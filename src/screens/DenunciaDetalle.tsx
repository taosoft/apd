...
import { StyleSheet, View, Text, Alert, TouchableOpacity, Image, Dimensions, ScrollView, FlatList } from 'react-native';
    ...
    <View style={styles.container}>
      <ScrollView keyboardShouldPersistTaps='always'>
        <View>
          ...
          <FlatList
            data={[
              { titulo: 'Nico es un capo ', fecha: "y Thom se la re come ", icono: "Mati tambien se la come" },
              { titulo: 'La ', fecha: "tuya", icono: "a mordiscones" },
              { titulo: 'No, ', fecha: "la ", icono: "tuya" },
            ]}
            renderItem={({ item }) => <ItemBitacora titulo={item.titulo} fecha={item.fecha} icono={item.icono} />}
